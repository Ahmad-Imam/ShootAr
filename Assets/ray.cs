       ...
       // Debug.Log("MARA UP ");
        ...
        if(wcomp())
        {
         // e1.transform.position = new Vector3(1, 1, 1);
            ...
            if (w % 2 > 0)
            {
                ab.transform.position = new Vector3(Random.Range(-1f, 3f), Random.Range(-.3f, .4f), Random.Range(1f, 2));
                ab.SetActive(true);
            }
            else
            {
                ab2.transform.position = new Vector3(Random.Range(-1f, 3f), Random.Range(-.3f, .4f), Random.Range(1, 2));
                ab2.SetActive(true);
            }
            if (w % 2 == 0 && w % 4 != 0)
            {
            ...
            else
            {
                ...
                if (Physics.Raycast(rayOrigin, out hitInfo, Mathf.Infinity))
                {
                    ...
                    if (hitInfo.transform.name == "Boss 1")
                    {
                        ...
                        cnt6++;
                        e6.transform.position = new Vector3(Random.Range(-3f, 5f), e6.transform.position.y, Random.Range(3f, 4f));
                    ...
                    {
                        cnt7++;
                        e7.transform.position = new Vector3(Random.Range(-3f, 4f), e7.transform.position.y, Random.Range(3f, 5f));
                        _hbar.setsize(cnt7);
                        if (cnt7 >= 3)
                        {
                            score += 50;
